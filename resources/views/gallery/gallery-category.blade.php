        ...
        <div class="col-lg-4 grid-margin ">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('add.gallery.category')}}" method="POST">
                        @csrf
                        <div class="mb-3">
                              ...
                              <div class="modal-dialog modal-md">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body ">
                                      <form class="forms-sample" action="{{route('update.blog.category', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data">
                                          @csrf
