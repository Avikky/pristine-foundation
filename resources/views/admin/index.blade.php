            ...
            <div class="card-body">
              ...
              <form class="forms-sample" id="updateabout" action="{{route('update.about')}}" method="POST" enctype="multipart/form-data">
               ...
               <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="about_us" class="form-label">About Description</label>
                  <textarea name="descript_1" id="descript_1"  class="form-control" cols="30" rows="10">{{$allSettings->about_descript}}</textarea>
                </div>
                <script>
                  CKEDITOR.replace('descript_1');
                </script>
