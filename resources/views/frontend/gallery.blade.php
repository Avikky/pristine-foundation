...
@section('content')
    ...
    <section class="page-title divider layer-overlay section-typo-light"
        data-tm-bg-img="{{ asset('uploads/images/' . $settings->banner) }}">
    ...
    <section class="layer-overlay overlay-white-5" data-tm-bg-img="{{ asset('frontend/images/bg/bg.png') }}"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="tm-sc tm-sc-gallery tm-sc-gallery-masonry gallery-style1-current-theme">
                            ...
                            <div class="filter-style-2 text-center mb-30">
                                @foreach ($galleryCategories as $key => $category)
                                <a href="{{route('gallery', ['category' => $category->id])}}" class="btn btn-dark btn-sm border-t-neutral-50" data-filter="*{{ $key }}"
                                        ...
                                        <div class="isotope-item  festival picnic">
                                            <div class="isotope-item-inner tm-gallery">
                                                <div class="tm-gallery-inner">
                                                    <div class="thumb ">
                                                        <a href="#"><img
                                                                src="{{ asset('uploads/gallerys/' . $gallery->image) }}"
                                                                alt></a>
                                                    </div>
                                                                ...
                                                                <div class="icons-holder-inner">
                                                                    <div class="styled-icons icon-dark icon-circled icon-theme-colored1">
                                                                        <a class="lightgallery-trigger styled-icons-item"
                                                                            data-exthumbimage="{{ asset('uploads/gallerys/' . $gallery->image) }}"
                                                                            title="{{$gallery->name}}"
                                                                            href="{{ asset('uploads/gallerys/' . $gallery->image) }}">

                                                                            <i class="fa fa-plus"></i>
                                                                        </a> 
                                                                        <a class="styled-icons-item"
                                                                            title="{{$gallery->name}}" href="#"><i
                                                                                class="fa fa-link"></i>
                                                                            </a>
                                                                    </div>
                                                                </div>
                                                                <div class="title-holder">
                                                                    <h5 class="title"><a href="#">{{$gallery->name}}</a></h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
